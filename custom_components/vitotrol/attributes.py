...
_CATEGORIES: dict[str, dict] = {
    ...
    "energy_wh":  dict(platform="sensor", unit=UnitOfEnergy.WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.MEASUREMENT),
...
_TABLE: list[tuple[int, str, bool, str]] = [
    ...
    (7895,  "Solar yield today",                  False,  "energy_wh"),
    (7896,  "Solar yield yesterday",              False,  "energy_wh"),
    (7897,  "Solar yield 2 days ago",             False,  "energy_wh"),
    (7898,  "Solar yield 3 days ago",             False,  "energy_wh"),
    (7899,  "Solar yield 4 days ago",             False,  "energy_wh"),
    (7900,  "Solar yield 5 days ago",             False,  "energy_wh"),
    (7901,  "Solar yield 6 days ago",             False,  "energy_wh"),
    (7902,  "Solar yield 7 days ago",             False,  "energy_wh"),
