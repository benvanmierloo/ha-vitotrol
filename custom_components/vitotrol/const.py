...
OPERATING_MODE_REQUESTED_MAP: dict[str, str] = {
    "0": "off",
    "1": "dhw_only",
    "2": "heating_and_dhw",
...
OPERATING_MODE_CURRENT_MAP: dict[str, str] = {
    "0": "standby",
    "1": "reduced",
    "2": "normal",
    "3": "continuous_normal",
...
INTERNAL_PUMP_STATUS_MAP: dict[str, str] = {
    "0": "off",
    "1": "on",
    "2": "off",
    "3": "on",
...
WAY3_VALVE_STATUS_MAP: dict[str, str] = {
    "0": "undefined",
    "1": "heating",
    "2": "middle",
    "3": "hot_water",
